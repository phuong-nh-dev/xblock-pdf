...
setup(
    name='xblock-pdf',
    version=VERSION,
    description='An XBlock which allows embedding of PDF files within an edX course',
    ...
    url='https://github.com/openedx/xblock-pdf',
    ...
    packages=['pdf'],
    package_data=package_data("pdf", ["static", "templates", "public", "translations", "conf"]),
