.PHONY: build_dummy_translations clean compile_translations detect_changed_source_translations docs dummy_translations extract_translations help quality requirements selfcheck upgrade validate_translations
...
upgrade:
	...
	pip-compile --upgrade -o requirements/quality.txt requirements/base.in requirements/quality.in
...
validate: quality validate_translations ## run quality checks
